...
export class ParseParamsList implements NestInterceptor {
  ...
  prepareRequestFilterDTO(query: any): Array<RequestFilterDTO> {
  ...
  prepareRequestCriteriaDTO(query: any): Array<RequestCriteriaDTO> {
  ...
  prepareRequestRangeDTO(query: any): Array<RequestCriteriaDTO> {
  ...
  prepareRequestSortCriteriaDTO(query: any): Array<RequestSortCriteriaDTO> {
  ...
  prepareRequestListDTO(query: any): RequestListDTO {
    ...
    const defaultOnPage = parseInt(
      this.configService.get('config.default_on_page'),
    );
    ...
    requestListDTO.sortcriteria = this.prepareRequestSortCriteriaDTO(query);
